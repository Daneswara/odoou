...
class daily_cash_qweb(models.AbstractModel):
    ...
    def get_journal(self):
        ...
        journal_obj = journal_src.search([('type', 'in', ('bank','cash'))])
        return journal_obj    
    ...
    def get_journal_item_penerimaan(self, report_date):
        ...
        move_line_obj = move_line_src.search([('account_id','in',account_ids),
                                              ('date','=',report_date),
                                              ('debit','>', 0)])
